...
setup(
    ...
    description='Create destroy and show AWS stacks',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/mozilla/identity-ops/tree/master/aws-tools/stack_control',
    ...
    keywords='persona aws cloudformation',
    ...
    entry_points={
        'console_scripts': [
            'stack_control=stack_control:main',
        ],
    },
)
