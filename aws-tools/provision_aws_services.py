...
'''
    ...
    desired_public_elbs_json['stage'] = '''
[
    {
        "name": "anosrep-org",
        "subnets" : 
...
'''
    ...
    for load_balancers_params in json.loads(desired_public_elbs_json[stack_type]) + json.loads(desired_private_elbs_json):
    ...
    example_secrets_json = '''
{
    ...
    [
        ...
        {
            "cert_name" : "wildcard.personatest.org",
            "cert_body": "-----BEGIN CERTIFICATE-----\\n9PZH15Pd\n-----END CERTIFICATE-----",
            "private_key": "-----BEGIN RSA PRIVATE KEY-----\\n-----END RSA PRIVATE KEY-----",
            "cert_chain": "-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----"
        }
